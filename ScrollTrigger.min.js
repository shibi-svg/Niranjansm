 ...
 * https://gsap.com
 * 
 * @license Copyright 2025, Sidharth Portfolio. All rights reserved.
 * @author: Sidharth - @zidhuxd.
 */
...
!function(e, t) {
    ...
    function G(r, n) {
        function dd(e) {
            if (e || 0 === e) {
                ...
                (n || qe.cache !== dd.cacheID || o("ref")) && (dd.cacheID = qe.cache,
                dd.v = r());
    ...
    function P(e) {
        return Te = e || r(),
        !Ce && Te && "undefined" != typeof document && document.body && (Se = window,
    ...
    var Te, Ce, Se, ke, Ee, Pe, Me, Oe, Ae, t, De, Be, Re, i = 1, Le = [], qe = [], Ie = [], Ye = Date.now, o = function _bridge(e, t) {
        return t
    ...
    var k = (Observer.prototype.init = function init(e) {
        ...
        var ee, te, re, ne, ie, oe, ae, se = this, le = 0, ce = 0, ue = e.passive || !s && !1 !== e.passive, fe = K(o, Fe), de = K(o, ze), pe = fe(), ge = de(), he = ~t.indexOf("touch") && !~t.indexOf("pointer") && "pointerdown" === Be[0], ve = A(o), be = o.ownerDocument || ke, me = [0, 0, 0], ye = [0, 0, 0], xe = 0, we = se.onPress = function(e) {
        ...
        , _e = se.onRelease = function(t) {
            if (!df(t, 1)) {
                ...
                !n && e && (se._vx.reset(),
                se._vy.reset(),
                s && Q && Te.delayedCall(.08, function() {
        ...
        se.enable = function(e) {
            ...
            (0 <= t.indexOf("touch") && Me || 0 <= t.indexOf("pointer")) && (B(o, Be[0], we, ue, j),
            B(be, Be[2], _e),
            B(be, Be[3], _e),
            Q && B(o, "click", cf, !0, !0),
            U && B(o, "click", tf),
    ...
    function Lb(e) {
        qe.cache++,
        !0 !== e && (Ke || h || Xe.fullscreenElement || Xe.webkitFullscreenElement || b && y === Ne.innerWidth && !(Math.abs(Ne.innerHeight - m) > .25 * Ne.innerHeight)) || c.restart(!0)
    }
    function Ob() {
    ...
    function Sb(e, t) {
        ...
        for (Qe = 0; Qe < Ct.length; Qe++)
            !(r = Ct[Qe]) || t && r._ctx !== t || (e ? r.kill(1) : r.revert(!0, !0));
        S = !0,
        t && Rb(t),
        t || U("revert")
    }
    ...
    var He, s, Ne, Xe, We, Je, l, c, Ve, Ue, Ge, u, Ke, je, f, Qe, d, p, g, Ze, $e, h, v, b, m, y, E, x, w, _, T, S, et, tt, D, rt, nt, it, ot = 1, at = Date.now, R = at(), st = 0, lt = 0, ct = function _isString(e) {
        ...
        D = 0
    }, $ = ["left", "top", I, q, mt + vt, mt + pt, mt + ht, mt + gt, "display", "flexShrink", "float", "zIndex", "gridColumnStart", "gridColumnEnd", "gridRowStart", "gridRowEnd", "gridArea", "justifySelf", "alignSelf", "placeSelf", "order"], ee = $.concat([ft, dt, "boxSizing", "max" + yt, "max" + Y, "position", mt, bt, bt + ht, bt + pt, bt + vt, bt + gt]), te = /([A-Z])/g, Mt = function _setState(e) {
        if (e) {
        ...
        lt) {
            ...
            te = He.delayedCall(ue.delay || i / 2 || .1, function() {
                var e = Ae()
                  , t = at() - Me < 500
                  , r = A.tween;
                if (!(t || Math.abs(Ce.getVelocity()) < 10) || r || je || Pe === e)
                    Ce.isActive && Pe !== e && te.restart(!0);
                else {
                    var n, i, o = (e - R) / N, a = O && !ve ? O.totalProgress() : o, s = t ? 0 : (a - _) / (at() - Ge) * 1e3 || 0, l = He.utils.clamp(-o, 1 - o, ut(s / 2) * s / .185), c = o + (!1 === ue.inertia ? 0 : l), u = ue.onStart, f = ue.onInterrupt, d = ue.onComplete;
                    if (n = p(c, Ce),
                    Ua(n) || (n = c),
            ...
            Ce.refresh = function(e, t, r, n) {
                if (!Ke && Ce.enabled || t)
                    if (ae && e && st)
                        ...
                        Ce._subPinOffset = !1;
                        var i, o, a, s, l, c, u, f, d, p, g, h, v, b = ke(), m = Ee(), y = de ? de.duration() : Qa(be, he), x = N <= .01, w = 0, _ = n || 0, T = Va(r) ? r.end : M.end, C = M.endTrigger || oe, S = Va(r) ? r.start : M.start || (0 !== M.start && oe ? ae ? "0 0" : "0 100%" : 0), k = Ce.pinnedContainer = M.pinnedContainer && J(M.pinnedContainer, Ce), E = oe && Math.max(0, Ct.indexOf(Ce)) || 0, P = E;
                        for (_e && Va(r) && (h = He.getProperty(Y, he.p),
                        v = He.getProperty(F, he.p)); 0 < P--; )
                        ...
                        for (Ta(S) && (S = S(Ce)),
                        S = Ca(S, "start", Ce),
                        R = mc(S, oe, b, he, Ae(), q, Y, Ce, m, Te, ye, y, de, Ce._startClamp && "_startClamp") || (ae ? -.001 : 0),
                        Ta(T) && (T = T(Ce)),
                        ct(T) && !T.indexOf("+=") && (~T.indexOf(" ") ? T = (ct(S) ? S.split(" ")[0] : "") + T : (w = Cb(T.substr(2), b),
                        T = ct(S) ? S : (de ? He.utils.mapRange(0, de.duration(), de.scrollTrigger.start, de.scrollTrigger.end, R) : R) + w,
                        C = oe)),
                        T = Ca(T, "end", Ce),
                        L = Math.max(R, mc(T || (C ? "100% 0" : y), C, b, he, Ae() + w, I, F, Ce, m, Te, ye, y, de, Ce._endClamp && "_endClamp")) || -.001,
                        w = 0,
                        P = E; P--; )
                            (u = (c = Ct[P]).pin) && c.start - c._pinPush <= R && !de && 0 < c.end && (i = c.end - (Ce._startClamp ? Math.max(0, c.start) : c.start),
                            (u === oe && c.start - c._pinPush < R || u === k) && isNaN(S) && (w += i * (1 - c.progress)),
                            u === ae && (_ += i));
                        if (R += w,
                        L += w,
                        Ce._startClamp && (Ce._startClamp += w),
                        Ce._endClamp && !rt && (Ce._endClamp = L || -.001,
                        ...
                        !ae || et && Ce.end >= Qa(be, he)) {
                            ...
                            (P = se === bt ? qb(ae, he) + N + _ : 0) && (Z.push(he.d, P + xt),
                            "auto" !== U.style.flexBasis && (U.style.flexBasis = P + xt)),
                            Mt(Z),
                            k && Ct.forEach(function(e) {
                                e.pin === k && !1 !== e.vars.pinSpacing && (e._subPinOffset = !0)
                            }),
                            ye && Ae(re)) : (P = qb(ae, he)) && "auto" !== U.style.flexBasis && (U.style.flexBasis = P + xt),
                            ye && ((l = {
                        ...
                        (x || Oe !== Ce.progress || de || le || O && !O._initted) && (O && !ve && O.totalProgress(de && R < -.001 && !Oe ? He.utils.normalize(R, L, 0) : Oe, !0),
            ...
            Ce.update = function(e, t, r) {
                if (!de || r || e) {
                    var n, i, o, a, s, l, c, u = !0 === rt ? re : Ce.scroll(), f = e ? 0 : (u - R) / N, d = f < 0 ? 0 : 1 < f ? 1 : f || 0, p = Ce.progress;
                    if (t && (B = D,
                    D = de ? Ae() : u,
                    ue && (_ = w,
                    w = O && !ve ? O.totalProgress() : d)),
                    P && ae && !Ke && !ot && st && (!d && R < u + (u - B) / (at() - Ge) * P ? d = 1e-4 : 1 === d && L > u + (u - B) / (at() - Ge) * P && (d = .9999)),
                    d !== p && Ce.enabled) {
                        if (a = (s = (n = Ce.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p,
                        Ce.direction = p < d ? 1 : -1,
                        Ce.progress = d,
                        a && !Ke && (i = d && !p ? 0 : 1 === d ? 1 : 1 === p ? 2 : 3,
                        ve && (o = !s && "none" !== we[i + 1] && we[i + 1] || we[i],
                        c = O && ("complete" === o || "reset" === o || o in O))),
                        ge && (s || c) && (c || E || !O) && (Ta(ge) ? ge(Ce) : Ce.getTrailing(ge).forEach(function(e) {
                            return e.endAnimation()
                        })),
                        ve || (!ee || Ke || ot ? O && O.totalProgress(d, !(!Ke || !Me && !e)) : (ee._dp._time - ee._start !== ee._time && ee.render(ee._dp._time - ee._start),
                        ...
                        ee ? ee.progress(1) : Wa(O, "reverse" === o ? 1 : !d, 1))) : ve && C && !Ke && C(Ce)
                    }
                    if (x) {
    ...
    ScrollTrigger.enable = function enable() {
        ...
        Je)) {
            ...
            Kb(),
            wb(Xe, "scroll", Jb);
            var e, t, r = Je.hasAttribute("style"), n = Je.style, i = n.borderTopStyle, o = He.core.Animation.prototype;
            ...
            , Xe, "DOMContentLoaded", Et, Ne, "load", Et, Ne, "resize", Lb],
            Ra(wb),
            Ct.forEach(function(e) {
                return e.enable(0, 1)
            }),
    ...
    ne.batch = function(e, t) {
        ...
        for (r in t)
            i[r] = "on" === r.substr(0, 2) && Ta(t[r]) && "onRefreshInit" !== r ? Ep(0, t[r]) : t[r];
        return Ta(a) && (a = a(),
    ...
    function wc(e) {
        var t, r = e.event, n = e.target, i = e.axis, o = (r.changedTouches ? r.changedTouches[0] : r).target, a = o._gsap || He.core.getCache(o), s = at();
        if (!a._isScrollT || 2e3 < s - a._isScrollT) {
            for (; o && o !== Je && (o.scrollHeight <= o.clientHeight && o.scrollWidth <= o.clientWidth || !oe[(t = mb(o)).overflowY] && !oe[t.overflowX]); )
                o = o.parentNode;
            a._isScroll = o && o !== n && !La(o) && (oe[(t = mb(o)).overflowY] || oe[t.overflowX]),
            a._isScrollT = s
        }
    ...
    function Bc(e) {
        ...
        var n, o, l, i, a, c, u, s, f = e.normalizeScrollX, t = e.momentum, r = e.allowNestedScroll, d = e.onRelease, p = J(e.target) || We, g = He.core.globals().ScrollSmoother, h = g && g.get(), v = E && (e.content && J(e.content) || h && !1 !== e.content && !h.smooth() && h.content()), b = K(p, ze), m = K(p, Fe), y = 1, x = (k.isTouch && Ne.visualViewport ? Ne.visualViewport.scale * Ne.visualViewport.width : Ne.outerWidth) / Ne.innerWidth, w = 0, _ = Ta(t) ? function() {
            return t(n)
        }
        : function() {
            return t || 2.8
        ...
        e.onRelease = e.onGestureStart = function(e, t) {
            ...
            t) {
                ...
                (E && a.vars.scrollY >= o || o - 1 <= r) && He.to({}, {
                    onUpdate: Lq,
                    duration: i
                })
            } else
