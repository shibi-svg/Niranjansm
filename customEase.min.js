...
!function(e, t) {
    ...
    function arcToSegment(e, t, n, s, a, r, i, o, h) {
        if (e !== o || t !== h) {
            ...
            R %= g,
            G %= g;
            var L, O = Math.ceil(F(G) / (g / 4)), j = [], z = G / O, I = 4 / 3 * k(z / 2) / (1 + B(z / 2)), H = c * n, Q = f * n, Z = f * -s, U = c * s;
            for (L = 0; L < O; L++)
                m = B(a = R + L * z),
                p = k(a),
                T = B(a += z),
    ...
    function stringToRawPath(e) {
        ...
        for (t = 0; t < v; t++)
            ...
            "M" === r)
                ...
                c = y - o[o.length - 4],
                f = M - o[o.length - 3],
                o.push(y + c, M + f, s + 2 / 3 * (y + 1.5 * c - s), a + 2 / 3 * (M + 1.5 * f - a), y = s, M = a),
                t += 2;
            else if ("H" === r)
                db(y, M, y = s, M),
                t += 1;
                ...
                d = x.charAt(1),
                x = x.charAt(0)),
                l = arcToSegment(y, M, +m[t + 1], +m[t + 2], +m[t + 3], +x, +d, (i ? y : 0) + 1 * c, (i ? M : 0) + 1 * f),
                t += n,
                l)
    ...
    function x(e, t, n, s, a, r, i, o, h, u, c) {
        var f, l = (e + n) / 2, g = (t + s) / 2, d = (n + a) / 2, m = (s + r) / 2, p = (a + i) / 2, y = (r + o) / 2, M = (l + d) / 2, v = (g + m) / 2, C = (d + p) / 2, E = (m + y) / 2, b = (M + C) / 2, w = (v + E) / 2, P = i - e, S = o - t, N = Math.abs((n - i) * S - (s - o) * P), D = Math.abs((a - i) * S - (r - o) * P);
        return u || (u = [{
            x: e,
            y: t
        }, {
    ...
    var M, a, t, y = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/gi, v = /[cLlsSaAhHvVtTqQ]/g, n = ((t = CustomEase.prototype).setData = function setData(e, t) {
        t = t || {};
        var n, s, a, r, i, o, h, u, c, f = (e = e || "0,0,1,1").match(y), l = 1, g = [], d = [], m = t.precision || 1, p = m <= 1;
        if (this.data = e,
        (v.test(e) || ~e.indexOf("M") && e.indexOf("C") < 0) && (f = stringToRawPath(e)[0]),
        4 === (n = f.length))
            f.unshift(0, 0),
            f.push(1, 1),
            n = 8;
        ...
        r = 2; r < n; r += 6)
            ...
            g.push(s, a),
            x(s.x, s.y, +f[r], +f[r + 1], +f[r + 2], +f[r + 3], a.x, a.y, 1 / (2e5 * m), g, g.length - 1);
        for (n = g.length,
        r = 0; r < n; r++)
            h = g[r],
            u = g[r - 1] || h,
    ...
    CustomEase.getSVGData = function getSVGData(e, t) {
        var n, a, r, i, o, h, u, c, f, l, g = (t = t || {}).width || 100, x = t.height || 100, d = t.x || 0, p = (t.y || 0) + x, y = M.utils.toArray(t.path)[0];
        if (t.invert && (x = -x,
        p = 0),
        ...
        e instanceof CustomEase)
            ...
            r = 2; r < u; r++)
                o = s(d + r * i * g),
                h = s(p + e(r * i) * -x),
                (Math.abs((h - l) / (o - f) - a) > c || r === u - 1) && (n.push(f, l),
                a = (h - l) / (o - f)),
                f = o,
                l = h;
            n = "M" + n.join(",")
