 ...
 * https://gsap.com
 * 
 * @license Copyright 2026, Niranjan sm Portfolio. All rights reserved.
 * @author: Niranjan sm - @Niranjan.
 */
...
!function(t, e) {
    ...
    g = {
        ...
        return !c && Rt.wake()
    }, Lt = {}, It = /^[\d.\-M][\d.\-,\s]/, Yt = /["']/g, Bt = function _invertEase(e) {
        return function(t) {
            return 1 - e(1 - t)
        }
    ...
    var Xt = function(i) {
        ...
        e.remove = function remove(t) {
            return r(t) ? this.removeLabel(t) : s(t) ? this.killTweensOf(t) : (t.parent === this && ya(this, t),
    ...
    var Nt, Gt, Wt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
        ...
        var i, n, a, s, o, u, h, l, f, d, c, p, _, m = t.vars, g = m.ease, v = m.startAt, y = m.immediateRender, T = m.lazy, b = m.onUpdate, x = m.runBackwards, k = m.yoyoEase, O = m.keyframes, M = m.autoRevert, P = t._dur, C = t._startAt, A = t._targets, S = t.parent, z = S && "nested" === S.data ? S.vars.targets : A, E = "auto" === t._overwrite && !F, D = t.timeline;
        if (!D || O && g || (g = "none"),
        t._ease = jt(g, V.ease),
    ...
    var $t = function(D) {
        function Tween(e, r, i, n) {
            ...
            r = i,
            i = null);
            var s, o, u, h, l, f, d, c, p = (a = D.call(this, n ? r : va(r)) || this).vars, _ = p.duration, m = p.delay, g = p.immediateRender, T = p.stagger, b = p.overwrite, x = p.keyframes, k = p.defaults, O = p.scrollTrigger, M = p.yoyoEase, P = r.parent || I, C = (Z(e) || $(e) ? t(e[0]) : "length"in r) ? [e] : Mt(e);
    ...
    $t.version = Xt.version = ze.version = "3.12.7",
    o = 1,
    x() && Ft();
    function vd(t, e) {
    ...
    function Td(t) {
        var e, r = t.ownerSVGElement, i = Od("svg", r && r.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), n = t.cloneNode(!0);
    ...
    function Vd(e) {
        ...
        return r && (r.width || r.height) || i || (r = Td(e)),
        !r || r.width || r.x || r.y ? r : {
            x: +Ud(e, ["x", "cx", "x1"]) || 0,
            y: +Ud(e, ["y", "cy", "y1"]) || 0,
            width: 0,
    ...
    var Ee, De, Re, Fe, Le, Ie, Ye, Be, qe = Lt.Power0, Ve = Lt.Power1, Ue = Lt.Power2, Xe = Lt.Power3, Ne = Lt.Power4, Ge = Lt.Linear, We = Lt.Quad, Qe = Lt.Cubic, Ke = Lt.Quart, Je = Lt.Quint, He = Lt.Strong, $e = Lt.Elastic, Ze = Lt.Back, tr = Lt.SteppedEase, er = Lt.Bounce, rr = Lt.Sine, ir = Lt.Expo, nr = Lt.Circ, ar = {}, sr = 180 / Math.PI, or = Math.PI / 180, ur = Math.atan2, hr = /([A-Z])/g, lr = /(left|right|width|margin|padding|x)/i, fr = /[\s,\(]\S/, dr = {
        ...
        n = "transformOrigin" !== e ? n[e] : n.svg ? n.origin : Or(Pd(t, pr)) + " " + n.zOrigin + "px") : (n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(") || (n = br[e] && br[e](t, e, r) || Pd(t, e) || ga(t, e) || ("opacity" === e ? 1 : 0)),
        ...
        if ("x"in r && !e && !r.uncache)
            return r;
        var i, n, a, s, o, u, h, l, f, d, c, p, _, m, g, v, y, T, b, w, x, k, O, M, P, C, A, S, z, E, D, R, F = t.style, L = r.scaleX < 0, I = "deg", Y = getComputedStyle(t), B = Pd(t, pr) || "0";
        return i = n = a = u = h = l = f = d = c = 0,
        s = o = 1,
        r.svg = !(!t.getCTM || !Wd(t)),
        Y.translate && ("none" === Y.translate && "none" === Y.scale && "none" === Y.rotate || (F[cr] = ("none" !== Y.translate ? "translate3d(" + (Y.translate + " 0 0").split(" ").slice(0, 3).join(", ") + ") " : "") + ("none" !== Y.rotate ? "rotate(" + Y.rotate + ") " : "") + ("none" !== Y.scale ? "scale(" + Y.scale.split(" ").join(",") + ") " : "") + ("none" !== Y[cr] ? Y[cr] : "")),
            ...
            e)
                ...
                !pt[d] || !ac(d, e, i, n, t, a)))
                    ...
                    f)
                        ...
                        if (k && d in k ? (s = "function" == typeof k[d] ? k[d].call(i, n, t, a) : k[d],
